...
function App() {
  ...
  return (
    <div className={dark ? 'theme-dark' : 'theme-light'}>
      ...
      <div className="content">
        ...
        <section className="section">
          ...
          <ul className="list">
            ...
            <li>
              <a href="https://github.com/ViceAguilera/ReviewBot.git" className="link">ReviewBot</a>
              <span className="desc"> » bot de Discord para generar reseñas de restaurantes con scraping.</span>
            </li>
            <li>
              <a href="https://github.com/ViceAguilera/Old_web_blog.git " className="link">Blog Personal</a>
      ...
      {cvOpen && (
        <div className="cv-modal" onClick={() => setCvOpen(false)}>
          <div className="cv-modal__inner" onClick={(e) => e.stopPropagation()}>
            <button
              type="button"
